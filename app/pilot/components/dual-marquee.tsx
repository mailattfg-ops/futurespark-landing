        ...
        <div style={{ marginBottom: 18, position: "relative" }}>
          <div className="marquee-track-left">
            {[
              ...
              { label: "Online Sessions with Offline Activity Materials", bg: "#faf5ff", border: "#e9d5ff", text: "#6b21a8" },
              ...
              { label: "Real-World Training", bg: "#eef2ff", border: "#c7d2fe", text: "#3730a3" },
