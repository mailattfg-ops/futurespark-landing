      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 max-w-4xl mx-auto">
          ...
          <ScrollReveal variant="fade-up" duration={600} delay={100}>
            <div className="rounded-3xl border border-gray-200/90 bg-white p-6 sm:p-8 flex flex-col items-center justify-between min-h-[220px] shadow-xs hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          ...
          <ScrollReveal variant="fade-up" duration={600} delay={200}>
            <div className="rounded-3xl border border-gray-200/90 bg-white p-6 sm:p-8 flex flex-col items-center justify-between min-h-[220px] shadow-xs hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        ...
        <ScrollReveal variant="fade-up" duration={600} delay={400} className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 max-w-2xl mx-auto mt-6 sm:mt-8">
          {/* Badge 1: ISO 27001 */}
